...
class AboutView extends HookConsumerWidget {
  ...
  static const _imageUrl = 'assets/images/Final-Main-Header.jpg';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final url0 = useState<String?>(null);

    return ErrorSnackbarView<void>(
      provider: launchProvider(url: url0.value),
      child: Scaffold(
        appBar: const WpaAppBar(title: Text('About'), actions: [SettingsIconButton()]),
        body: SingleChildScrollView(
          child: Column(
            children: [
              Image.asset(_imageUrl, errorBuilder: (_, __, ___) => const SizedBox()),
